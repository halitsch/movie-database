class UsersController < ApplicationController
  ...
  # GET /users.json
  def index
    @users = User.order(sort_column(User) + " " + sort_direction).paginate(per_page: 10, page: params[:page])
  end
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:user_id, :user_name, :first_name, :last_name, :gender, :dob, :email, :phone, :address)
    end
end
